...
$canedit = canUsercan_edit($pdo, 'Center Management'); // <-- use new
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($centre) {
        ...
        $phone = $centre['phone'];
        $email = $centre['email'];
        $center_coordinator_name = $centre['center_coordinator_name'] ?? "";
    }
}
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="center_coordinator_name" name="center_coordinator_name"
                                            value="<?= htmlspecialchars($center_coordinator_name) ?>">
