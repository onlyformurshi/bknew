  ...
  <section class="hero-section">
    <div class="container">
      <div class="row justify-content-center text-center hero-content">
        <div class="col-lg-8">
          <h1 class="display-5 fw-bold mb-3">Explore Our Upcoming Programs</h1>
          <p class="lead mb-4">Discover meaningful experiences that inspire personal growth and community connection.</p>
    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-4">
        <div class="col-lg-8">
          ...
          <p class="section-subtitle">Find a Program That Fits Your Interests and Schedule

Browse our list of upcoming programs and events near you.</p>
        </div>
      </div>
...
?>  
                <div class="info-item">
                  ...
                  <div class="info-content">
                    ...
                    <div class="info-value"><?= htmlspecialchars($current) ?>/ <?= $program['max_participants'] ?> registered</div>
  ...
  <section class="py-5" style="background: var(--primary-gradient);">
    <div class="container">
      <div class="row justify-content-center text-center text-white">
        <div class="col-lg-8">
          <h2 class="display-5 fw-bold mb-3">Ready to Join a Program?</h2>
          <p class="lead mb-4">Take the Next Step in Your Personal Journey

Register now and be part of transformative experiences that make a difference.</p>
